...
for experience_row in experience_rows:
    experience_columns = experience_row.find_all("td")

    experience_fields = [column.getText() for column in experience_columns]
    (rank, name, character_class, level, experience_value, *_) = experience_fields
